            ...
            <div className="flex flex-col gap-6 mb-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">The Space, Office No. 220, 2nd Floor, Grant Rd, Opposite Eon Free Zone Phase 2 Road, Rajaram Patil Nagar, Kharadi, Pune – 411014</p>
                </div>
              </div>
