...
const Footer = () => {
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>The Space, Office No. 220, 2nd Floor, Grant Rd, Opposite Eon Free Zone Phase 2 Road, Rajaram Patil Nagar, Kharadi, Pune- 411014</span>
            </li>
  ...
  <p className="text-xs text-gray-500 leading-relaxed mb-3 max-w-4xl mx-auto">
    <span className="font-semibold text-gray-400">Disclaimer:</span> Infinity 99 Realty is only an intermediary offering its platform to advertise properties of Seller for a Customer/Buyer/User coming on its Website and is not and cannot be a party to or privy to or control in any manner any transactions between the Seller and the Customer/Buyer/User. All the prices or rates on this Website have been extended by various Builder(s)/Developer(s) who have advertised their products. Company shall neither be responsible nor liable to mediate or resolve any disputes or disagreements between the Customer/Buyer/User and the Seller and both Seller and Customer/Buyer/User shall settle all such disputes without involving Company in any manner.
  </p>
  <p className="text-xs text-gray-600 mb-1">
    © 2026 <span className="text-yellow-500 font-medium">Infinity 99 Realty</span>. All Rights Reserved. | MahaRERA Certified Advisory Firm | Kharadi, Pune
  </p>
